...
input_list = pickle.load(open("../Datasets/processed/train_input_list_4_vector.pkl", "rb"))
label_list = pickle.load(open("../Datasets/processed/train_label_list_4_vector.pkl", "rb"))
...
model.fit(symbol_input, symbol_one_hot, epochs=20, batch_size=2, callbacks=[cp_callback, tensorboard_callback])
